              ...
              {(settings as any)?.contact_phone && (
                <div className="flex items-center space-x-3">
                  ...
                  <a href={`tel:${(settings as any).contact_phone}`} className="text-gray-400 hover:text-white transition-colors duration-200">
                    {(settings as any).contact_phone.startsWith('+62') ? '0' + (settings as any).contact_phone.substring(3) : 
                     (settings as any).contact_phone.startsWith('62') ? '0' + (settings as any).contact_phone.substring(2) : 
                     (settings as any).contact_phone}
                  </a>
                </div>
              )}
              ...
              {(settings as any)?.cta_whatsapp_number && (
                <div className="flex items-center space-x-3">
                  ...
                  <a href={`https://wa.me/${(settings as any).cta_whatsapp_number.replace(/[^0-9]/g, '')}`} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors duration-200">
                    {(settings as any).cta_whatsapp_number.startsWith('+62') ? '0' + (settings as any).cta_whatsapp_number.substring(3) : 
                     (settings as any).cta_whatsapp_number.startsWith('62') ? '0' + (settings as any).cta_whatsapp_number.substring(2) : 
                     (settings as any).cta_whatsapp_number}
                  </a>
                </div>
              )}
